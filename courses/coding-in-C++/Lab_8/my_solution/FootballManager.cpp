...
{
    if (intensity > 30) //Violates Liskov Substitution Principle as it changes the expected behavior of the base class method
    {
...
void FootballManager::select_strategy(const std::string &strategy) //Violates Open/Closed Principle as it requires modification to add new strategies
{
